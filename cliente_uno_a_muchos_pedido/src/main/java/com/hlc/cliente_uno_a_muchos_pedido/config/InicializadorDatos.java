	...
	public void run(String... args) throws Exception {
		for (int i = 0; i < 5; i++) {
            ...
            for (int j = 0; j < 3; j++) {
                ...
                producto1.setPeso(faker.number().numberBetween(1, 50));
                producto1.setStock(faker.number().numberBetween(1, 120));
        		...
        		producto2.setPeso(faker.number().numberBetween(1, 50));
        		producto2.setStock(faker.number().numberBetween(1, 120));
